    ...
    <div class="row">
            ...
            <form>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label>
                      <input v-model="userData.interests" type="checkbox" value="Yazılım"> Yazılım
                    </label>
                    <label>
                      <input v-model="userData.interests" type="checkbox" value="Donanım"> Donanım
                    </label>
                  </div>
      ...
      <div class="col-md-6">
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              <p>Kullanıcı Adı: <strong>{{userData.username}}</strong></p>
              <p>Şifre: <strong>{{userData.password}}</strong></p>
              <p>Yaş: <strong>{{userData.age}}</strong></p>
              <p style="white-space: pre;">Açıklama: <strong>{{userData.message}}</strong></p>
